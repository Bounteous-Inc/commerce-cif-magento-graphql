...
public class Customer extends AbstractResponse<Customer> {
    ...
    public Customer(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
                    ...
                    if (!field.getValue().isJsonNull()) {
                        ...
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            ...
                            if (!element1.isJsonNull()) {
                                optional2 = new CustomerAddress(jsonAsObject(element1, key), ignoreUnknownFields);
                            }

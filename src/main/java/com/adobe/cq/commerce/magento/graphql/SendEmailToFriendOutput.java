...
public class SendEmailToFriendOutput extends AbstractResponse<SendEmailToFriendOutput> {
    ...
    public SendEmailToFriendOutput(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
        ...
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        ...
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            ...
                            if (!element1.isJsonNull()) {
                                optional2 = new SendEmailToFriendRecipient(jsonAsObject(element1, key), ignoreUnknownFields);
                            }
                ...
                case "sender": {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new SendEmailToFriendSender(jsonAsObject(field.getValue(), key), ignoreUnknownFields);
                    }

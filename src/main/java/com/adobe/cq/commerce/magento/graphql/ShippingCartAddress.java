...
public class ShippingCartAddress extends AbstractResponse<ShippingCartAddress> implements CartAddressInterface {
    ...
    public ShippingCartAddress(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
        ...
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        ...
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            ...
                            if (!element1.isJsonNull()) {
                                optional2 = new AvailableShippingMethod(jsonAsObject(element1, key), ignoreUnknownFields);
                            }
                ...
                case "cart_items": {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        ...
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            ...
                            if (!element1.isJsonNull()) {
                                optional2 = new CartItemQuantity(jsonAsObject(element1, key), ignoreUnknownFields);
                            }
                ...
                case "selected_shipping_method": {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new SelectedShippingMethod(jsonAsObject(field.getValue(), key), ignoreUnknownFields);
                    }

...
public class CustomizableFieldOption extends AbstractResponse<CustomizableFieldOption> implements CustomizableOptionInterface {
    ...
    public CustomizableFieldOption(JsonObject fields) throws SchemaViolationError {
        this(fields, false);
    }

    public CustomizableFieldOption(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
        ...
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "value": {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new CustomizableFieldValue(jsonAsObject(field.getValue(), key), ignoreUnknownFields);
                    }
    ...
    public CustomizableFieldOption setOptionId(Integer arg) {
    ...
    public CustomizableFieldOption setProductSku(String arg) {
    ...
    public CustomizableFieldOption setRequired(Boolean arg) {
    ...
    public CustomizableFieldOption setSortOrder(Integer arg) {
    ...
    public CustomizableFieldOption setTitle(String arg) {
    ...
    public CustomizableFieldOption setValue(CustomizableFieldValue arg) {

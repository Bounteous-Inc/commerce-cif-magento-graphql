 ...
 * inventory.
 */
public class LumaVirtualProduct extends VirtualProduct implements CustomizableProductInterface, ProductInterface {
    public LumaVirtualProduct() {
        super();
    }

    public LumaVirtualProduct(JsonObject fields) throws SchemaViolationError {
        super(fields, true);
    ...
    public LumaVirtualProduct setActivity(String arg) {
    ...
    public LumaVirtualProduct setCategoryGear(String arg) {
    ...
    public LumaVirtualProduct setClimate(String arg) {
    ...
    public LumaVirtualProduct setCollar(String arg) {
    ...
    public LumaVirtualProduct setEcoCollection(Integer arg) {
    ...
    public LumaVirtualProduct setErinRecommends(Integer arg) {
    ...
    public LumaVirtualProduct setFeaturesBags(String arg) {
    ...
    public LumaVirtualProduct setFormat(Integer arg) {
    ...
    public LumaVirtualProduct setGender(String arg) {
    ...
    public LumaVirtualProduct setMaterial(String arg) {
    ...
    public LumaVirtualProduct setNew(Integer arg) {
    ...
    public LumaVirtualProduct setPattern(String arg) {
    ...
    public LumaVirtualProduct setPerformanceFabric(Integer arg) {
    ...
    public LumaVirtualProduct setSale(Integer arg) {
    ...
    public LumaVirtualProduct setSize(Integer arg) {
    ...
    public LumaVirtualProduct setSleeve(String arg) {
    ...
    public LumaVirtualProduct setStrapBags(String arg) {
    ...
    public LumaVirtualProduct setStyleBags(String arg) {
    ...
    public LumaVirtualProduct setStyleBottom(String arg) {
    ...
    public LumaVirtualProduct setStyleGeneral(String arg) {

...
public class PayflowProToken extends AbstractResponse<PayflowProToken> {
    ...
    public PayflowProToken(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
    ...
    public PayflowProToken setResponseMessage(String arg) {
    ...
    public PayflowProToken setResult(Integer arg) {
    ...
    public PayflowProToken setResultCode(Integer arg) {
    ...
    public PayflowProToken setSecureToken(String arg) {
    ...
    public PayflowProToken setSecureTokenId(String arg) {

...
public class ComplexTextValue extends AbstractResponse<ComplexTextValue> {
    ...
    public ComplexTextValue(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
    ...
    public ComplexTextValue setHtml(String arg) {
        optimisticData.put(getKey("html"), arg);
        return this;
    }

...
public class RevokeCustomerTokenOutput extends AbstractResponse<RevokeCustomerTokenOutput> {
    ...
    public RevokeCustomerTokenOutput(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
    ...
    public RevokeCustomerTokenOutput setResult(Boolean arg) {

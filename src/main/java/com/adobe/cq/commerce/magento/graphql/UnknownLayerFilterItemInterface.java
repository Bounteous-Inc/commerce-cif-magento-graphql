...
public class UnknownLayerFilterItemInterface extends AbstractResponse<UnknownLayerFilterItemInterface> implements LayerFilterItemInterface {
    ...
    public UnknownLayerFilterItemInterface setItemsCount(Integer arg) {
    ...
    public UnknownLayerFilterItemInterface setLabel(String arg) {
    ...
    public UnknownLayerFilterItemInterface setValueString(String arg) {

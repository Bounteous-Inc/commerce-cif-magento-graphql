...
public class CartPrices extends AbstractResponse<CartPrices> {
    ...
    public CartPrices(JsonObject fields, boolean ignoreUnknownFields) throws SchemaViolationError {
        this.fields = fields;
        ...
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        ...
                        for (JsonElement element1 : jsonAsArray(field.getValue(), key)) {
                            ...
                            if (!element1.isJsonNull()) {
                                optional2 = new CartTaxItem(jsonAsObject(element1, key), ignoreUnknownFields);
                            }
                ...
                case "discount": {
                    ...
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new CartDiscount(jsonAsObject(field.getValue(), key), ignoreUnknownFields);
                    }
